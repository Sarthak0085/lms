...
import { getColumns } from "./review-table-columns"
...
interface ReviewsTableProps {
    reviewsPromise: ReturnType<typeof getReviews>
}

export const ReviewsTable = ({ reviewsPromise }: ReviewsTableProps) => {

    const { data, pageCount } = React.use(reviewsPromise);
